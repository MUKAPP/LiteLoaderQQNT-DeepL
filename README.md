...
也可以同时安装 [Protocio](https://github.com/PRO-2684/protocio) 插件，然后点击 <a href="llqqnt://plugininstaller/MUKAPP/LiteLoaderQQNT-DeepL/main/manifest.json">该链接</a> 直接拉起 PluginInstaller 安装插件
